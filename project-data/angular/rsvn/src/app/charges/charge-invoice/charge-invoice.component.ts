...
export class ChargeInvoiceComponent implements OnInit {
  fullRoomList: any[] = [];
  roomChargeData: any = [];
  chargeList: ICharge[] = [];
        ...
        {text: 'Room Charges', style: 'subheader'},
        {
          ...
          table: {
            ...
            body: [
              ...
              ...this.roomCharges(),
              ['', '', { text: 'Subtotal', style: 'totalCell'}, { text: `$${this.data.roomSubTotal.toFixed(2)}`, style: 'alignRight' }]
            ]
          },
        },
        {text: 'Charges', style: 'subheader'},
        {
          ...
          table: {
            ...
            body: [
              ...
              ...this.charges(),
              ['', '', '', '', { text: 'Subtotal', style: 'totalCell' }, { text: `$${this.data.chgSubTotal.toFixed(2)}`, style: 'alignRight' }]
            ]
          }
        },
        {text: 'Payments', style: 'subheader'},
        {
          ...
          table: {
            ...
            body: [
              ...
              ...this.payments(),
              ['',  '', { text: 'Subtotal', style: 'totalCell' }, { text: `$${this.data.pmtSubTotal.toFixed(2)}`, style: 'alignRight' }]
            ]
          }
        },
        {text: 'Total', style: 'subheader'},
        {
          ...
          table: {
            ...
            body: [
              ...
              [ '', { text: 'Total', style: 'totalCell' }, { text: `$${this.data.grandTotal.toFixed(2)}`, style: 'alignRight' }]
            ]
          }
        }
      ],
  ...
  //--------------------------
  ngOnInit(): void {
    this.chargeService.getRsvnRoomCharge(this.data.currRsvnId).subscribe(data => {
      this.roomChargeData = data;
    })

    this.chargeService.getRsvnCharge(this.data.currRsvnId).subscribe(data => {
      this.chargeList = data;
    })

    this.chargeService.getRsvnPayment(this.data.currRsvnId).subscribe(data=> {
